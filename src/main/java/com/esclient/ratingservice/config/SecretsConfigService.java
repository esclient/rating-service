...
public class SecretsConfigService {
    ...
    public SecretsConfigService(
        ...
        @Value("${INFISICAL_ENVIRONMENT}") String environment) {
    ...
    public String getSecret(String secretName, String path) {
        try {
            ...
            LOGGER.error("Failed to retrieve secret '{}' from path '{}': {}", secretName, path, e.getMessage());
            return null;
        }
    }
    
    /**
     * Retrieve a secret from Infisical using default path "/" with exception throwing
     * Use this when you want to handle the exception in the calling code
     */
    public String getSecretOrThrow(String secretName) throws RuntimeException {
     ...
     * Use this when you want to handle the exception in the calling code
     */
    public String getSecretOrThrow(String secretName, String path) throws RuntimeException {
        if (secretName == null || secretName.trim().isEmpty()) {
