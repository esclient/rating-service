...
public class LoggingConfig {
    ...
    public void configureLogging() {
        ...
        try {
            Level level = Level.valueOf(rootLogLevel.toUpperCase());
        ...
        logger.info("Logging configured successfully - Level: {}, Service: {}, Environment: {}", 
                   rootLogLevel, serviceName, environment);
    }
