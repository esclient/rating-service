...
public final class RatingServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<
          rating.Rating.RateModRequest, rating.Rating.RateModResponse>
      METHOD_RATE_MOD = getRateModMethod();
  ...
  public static io.grpc.MethodDescriptor<
          rating.Rating.RateModRequest, rating.Rating.RateModResponse>
      getRateModMethod() {
    io.grpc.MethodDescriptor<rating.Rating.RateModRequest, rating.Rating.RateModResponse>
        getRateModMethod;
    if ((getRateModMethod = RatingServiceGrpc.getRateModMethod) == null) {
      synchronized (RatingServiceGrpc.class) {
        if ((getRateModMethod = RatingServiceGrpc.getRateModMethod) == null) {
          RatingServiceGrpc.getRateModMethod =
              getRateModMethod =
                  io.grpc.MethodDescriptor
                      .<rating.Rating.RateModRequest, rating.Rating.RateModResponse>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(generateFullMethodName("rating.RatingService", "RateMod"))
  ...
  public static final io.grpc.MethodDescriptor<
          rating.Rating.GetRatesRequest, rating.Rating.GetRatesResponse>
      METHOD_GET_RATES = getGetRatesMethod();
  ...
  public static io.grpc.MethodDescriptor<
          rating.Rating.GetRatesRequest, rating.Rating.GetRatesResponse>
      getGetRatesMethod() {
    io.grpc.MethodDescriptor<rating.Rating.GetRatesRequest, rating.Rating.GetRatesResponse>
        getGetRatesMethod;
    if ((getGetRatesMethod = RatingServiceGrpc.getGetRatesMethod) == null) {
      synchronized (RatingServiceGrpc.class) {
        if ((getGetRatesMethod = RatingServiceGrpc.getGetRatesMethod) == null) {
          RatingServiceGrpc.getGetRatesMethod =
              getGetRatesMethod =
                  io.grpc.MethodDescriptor
                      .<rating.Rating.GetRatesRequest, rating.Rating.GetRatesResponse>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(generateFullMethodName("rating.RatingService", "GetRates"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
   ...
   */
  public static RatingServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    return new RatingServiceBlockingStub(channel);
  }

  /** Creates a new ListenableFuture-style stub that supports unary calls on the service */
  public static RatingServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    return new RatingServiceFutureStub(channel);
  }

  /** */
  public abstract static class RatingServiceImplBase implements io.grpc.BindableService {
    ...
    public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
              getRateModMethod(),
              asyncUnaryCall(
                  new MethodHandlers<rating.Rating.RateModRequest, rating.Rating.RateModResponse>(
                      this, METHODID_RATE_MOD)))
          .addMethod(
              getGetRatesMethod(),
              asyncUnaryCall(
                  new MethodHandlers<rating.Rating.GetRatesRequest, rating.Rating.GetRatesResponse>(
  ...
  public static final class RatingServiceStub extends io.grpc.stub.AbstractStub<RatingServiceStub> {
    ...
    private RatingServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RatingServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static final class RatingServiceBlockingStub
      extends io.grpc.stub.AbstractStub<RatingServiceBlockingStub> {
    private RatingServiceBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RatingServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public rating.Rating.RateModResponse rateMod(rating.Rating.RateModRequest request) {
      return blockingUnaryCall(getChannel(), getRateModMethod(), getCallOptions(), request);
    }

    /** */
    public rating.Rating.GetRatesResponse getRates(rating.Rating.GetRatesRequest request) {
      return blockingUnaryCall(getChannel(), getGetRatesMethod(), getCallOptions(), request);
    }
  }

  /** */
  public static final class RatingServiceFutureStub
      extends io.grpc.stub.AbstractStub<RatingServiceFutureStub> {
    private RatingServiceFutureStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RatingServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    /** */
    public com.google.common.util.concurrent.ListenableFuture<rating.Rating.RateModResponse>
        rateMod(rating.Rating.RateModRequest request) {
      return futureUnaryCall(getChannel().newCall(getRateModMethod(), getCallOptions()), request);
    }

    /** */
    public com.google.common.util.concurrent.ListenableFuture<rating.Rating.GetRatesResponse>
        getRates(rating.Rating.GetRatesRequest request) {
      return futureUnaryCall(getChannel().newCall(getGetRatesMethod(), getCallOptions()), request);
    }
  }
  ...
  private abstract static class RatingServiceBaseDescriptorSupplier
